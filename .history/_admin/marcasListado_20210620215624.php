        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Todos las Marcas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Marcas <a href="categoriasForm.php"><i class="fas fa-plus"></i></a></h3>
                  ...
                  <tbody>
                    <?php foreach(businessObtenerMarcas() as $cat){ ?>
                        <tr>
                            ...
                            <td>
                            <a href="marcasForm.php?edit=<?php echo $cat['id']?>"> <i class="fas fa-th"></i></a>
                            <a href="marcasListado.php?del=<?php echo $cat['id']?>"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                  </tbody>
