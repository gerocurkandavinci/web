         ...
         <!-- <select name="select"> -->
             <!-- <option value="value1">Value 1</option> -->
              <select class="filter__list">
               ...
               <button style="margin-left: 3px;" type="button" class="btn-xs btn-primary" href="product-details.php?producto=<?php echo $producto['id']?>"><?php echo $producto['nombre']? >Filtrar</button>
