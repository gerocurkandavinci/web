                                     ...
                                     $categorias = json_decode(file_get_contents(DIR_BASE.'datos/categoria.json'),TRUE);	
                                                ...
                                                foreach($categorias as $cat){   
                                                   ?>
                                                    ...
                                                    <!-- <li class="is-checked"><a href="?categoria=<?php echo $cat['id']?>"><?php echo $cat['nombre']?></a></li> -->
                                                    
                                                    <button class="is-checked" role="link" onclick="?categoria=<?php echo $cat['id']?"><?php echo $cat['nombre']?></button>
                                                   <?php
                                                }
                                             ?>                                 
