              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" name="nombre" value="<?php echo $categoria['nombre']?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Activo</label>
                    <input type="checkbox" class="form-check-label" id="" value="true" name="activo" <?php echo ($categoria['activa']==TRUE)?'checked':'' ?>>
                  </div>
                </div>
                <!-- /.card-body -->
