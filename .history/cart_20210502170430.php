                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-7 col-xs-12">
                                    <div class="buttons-cart">
                                        <input type="submit" value="Refrescar Carrito" />
                                        <a href="#">Seguir comprando</a>
                                    </div>
                                    <div class="coupon">
                                        <h3>Cupon</h3>
                                        <p>Ingresar el cupon de descuento.</p>
                                        <input type="text" placeholder="Codigo de cupon"/>
                                        <input type="submit" value="Aplicar Coupon" />
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-5 col-xs-12">
                                    <div class="cart_totals">
                                        <h2>Totale de la compra</h2>
                                        <table>
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <ul id="shipping_method">
                                                            <li>
                                                                <input type="radio" /> 
                                                                <label>
                                                                    Delivery: <span class="amount">$7.00</span>
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <input type="radio" /> 
                                                        ...
                                                        <p><a class="shipping-calculator-button" href="#">Calcular envio</a></p>
                                                    </td>
                                                </tr>
