...
if(isset($_GET['del'])){
    ...
    redirect('categoriassListado.php');
}
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Todos las Categorias</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Categorias <a href="categoriasForm.php"><i class="fas fa-plus"></i></a></h3>
                  ...
                  <tbody>
                    <?php foreach(businessObtenerCategorias() as $cat){ ?>
                        <tr>
                            ...
                            <td>
                            <a href="categoriasForm.php?edit=<?php echo $cat['id']?>"> <i class="fas fa-th"></i></a>
                            <a href="categoriaListado.php?del=<?php echo $cat['id']?>"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                  </tbody>
