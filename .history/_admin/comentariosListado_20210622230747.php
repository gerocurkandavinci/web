        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="float:left;list-inline;"> 
                  <?php
                    ...
                    ?>
                    <ul class="list-inline"><li class="dl-horizontal"><a class="dropdown-item" href="comentariosListado.php?id=<?php echo $producto['id'] ?>" type="button"  > 
                    <?php echo $producto['nombre']?></a></li></ul>
                <?php
                }?>
                <ul class="list-inline"><li class="dl-horizontal"><a class="dropdown-item" href="comentariosListado.php?id=0" type="button">Todos</a></li></ul>                  
            </div>
        </div>           
