             ...
             <!-- <option value="value1">Value 1</option> -->
               <!-- <select class="filter__list">
                  ...
                  <div class="dropdown-menu">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="height:auto; max-height: 200px; "> 
                      <?php
                  $productos = businessObtenerProductos();
                       foreach($productos as $producto){  
                        ?>
                         
                        <li><a class="dropdown-item" href="comentariosListado.php?id=<?php echo $producto['id'] ?>" type="button"  > 
                                <?php echo $producto['nombre']?></a></li>
