         ...
         <!-- <select name="select"> -->
             <!-- <option value="value1">Value 1</option> -->
              <select class="filter__list">
                   <?php
                      $productos = json_decode(file_get_contents(DIR_BASE.'datos/comentarios.json'),TRUE);
               ...
               <button style="margin-left: 3px;" type="button" class="btn-xs btn-primary" href="product-details.php?producto=1" >Filtrar</button>
