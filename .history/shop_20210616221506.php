                                        ...
                                        <div class="single__filter">
                                            ...
                                            <?php
                                                ...
                                                foreach($categorias as $cat){   
                                                   ?>
                                                    <li><a href="#shop.php?categoria=<?php echo $cat['id']?>"><?php echo $cat['nombre']?></a></li>
                                                   <?php
                                                }
                                             ?>
                                              <li><a href="#shop.php?categoria=<?php echo $cat['null']?>">Todas</a></li>  
                                            </ul>
                                        ...
                                        <div class="single__filter">
                                            ...
                                            <?php
                                                ...
                                                foreach($marcas as $mar){   
                                                   ?>
                                                    <li><a href="#shop.php?categoria=<?php echo $mar['id']?>"><?php echo $mar['nombre']?></a></li>
                                                   <?php
                                                }
                                             ?>
