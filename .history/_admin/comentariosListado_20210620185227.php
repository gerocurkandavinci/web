                   ...
                   <?php
                      $productos = json_decode(file_get_contents(DIR_BASE.'datos/productos.json'),TRUE);
                       ...
                       foreach($productos as $producto){   
                        ...
                        <option><a href="href="product-details.php?producto=<?php echo $producto['id']?>"><?php echo $producto['nombre']?></a></option>
                        <?php
                        } ?>
                  ...
                  <tbody>
                    <?php foreach(businessObtenerComentarios() as $Coment){ ?>
                        <tr>
                            ...
                            <td><?php echo $categorias[$Coment['producto']]['nombre'] ?></td>
                            <td><?php echo $Coment['comentario'] ?></td> 

                            <td>
                            <!-- <a href="productosForm.php?edit=<?php echo $Coment['id']?>"> <i class="fas fa-th"></i></a> -->
                            <!-- <a href="comentariosListado.php?del=<?php echo $Coment['id']?>"><i class="fas fa-trash"></i></a> -->
                            </td>
                        </tr>
                    <?php } ?>
