                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-3 col-xs-3">
                            <div class="menu-fixed" style='margin-top: 0px; margin-bottom:0px'>
                                <a href="index.html">
                        ...
                        <div class="col-md-8 col-lg-8 col-sm-6 col-xs-6">
                            <nav class="mainmenu__nav hidden-xs hidden-sm">
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="shop.php">Tienda</a></li>
        ...
        <div class="offset__wrapper">
            ...
            <div class="offsetmenu">
                <div class="offsetmenu__inner">
                    ...
                    <div class="col-md-12" style='margin-top:-40%; margin-bottom: -20%'>
                        <div class="logo">
                            <a href="index.html">
                                <img src="images/logo/first2.png" alt="logo">
                            </a>
                    ...
                    <ul class="sidebar__thumd" style='margin-top:-30%;'>
                        <li>
                    ...
                    <div class="offset__sosial__share">
                        <h4 class="offset__title">Siguenos en nuestras redes</h4>
