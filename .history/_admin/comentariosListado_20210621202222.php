        ...
        <div class="card-header">
         ...
         <!-- <select name="select"> -->
             <!-- <option value="value1">Value 1</option> -->
               <select class="filter__list">
                  <?php
                       foreach($productos as $producto){  
                        ?>
                        <option>
                                <a  href="comentariosListado.php?id=<?php echo $producto['id'] ?>" type="button" class="btn btn-block btn-primary btn-xs"> 
               ...
               <button style="margin-left: 3px;" type="button" class="btn-xs btn-primary" (click)="onClick('id')" >Filtrar</button>
