...
<?php
    ...
    require_once(DIR_BASE.'business/productosBusiness.php');
?>
<head>
    <meta charset="utf-8">
                                        ...
                                        <a href="#"><img alt="" src="">Parrilla<i class="zmdi zmdi-chevron-right"></i></a>
                                            ...
                                            <div class="category-menu-dropdown-left">
                                                ...
                                                <div class="category-part-2 category-common">
                                                    ...
                                                    <ul>
                                                    <li><a href="product-details.php?producto=3">Tapa de Asado</a></li>
                                                    <li><a href="product-details.php?producto=1">Entraña</a></li>
                                                    <li><a href="product-details.php?producto=5">Asado del centro</a></li>
                                                    <li><a href="product-details.php?producto=2">Matambre</a></li>
                                                    <li><a href="product-details.php?producto=4">Vacío</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <a href="#"><img alt="" src="">Milanesas<i class="zmdi zmdi-chevron-right"></i></a>
                                            ...
                                            <div class="category-menu-dropdown-left">
                                                ...
                                                <div class="category-part-2 category-common">
                                                    <h4 class="categories-subtitle"></h4>
                                                    <ul>
                                                    <li><a href="product-details.php?producto=8">Milanesas de peceto</a></li>
                                                    <li><a href="product-details.php?producto=9">Milanesas de nalga </a></li>
                                                    <li><a href="product-details.php?producto=6">Milanesas de cuadrada</a></li>
                                                    <li><a href="product-details.php?producto=7">Milanesas de bola de lomo</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="category-menu-dropdown-right">
                                    ...
                                    <a href="#"><img alt="" src="">Gourmet<i class="zmdi zmdi-chevron-right"></i></a>
                                            ...
                                            <div class="category-menu-dropdown-left">
                                                ...
                                                <div class="category-part-2 category-common">
                                                    <h4 class="categories-subtitle"></h4>
                                                    <ul>
                                                    <li><a href="product-details.php?producto=10">Colita de cuadril</a></li>
                                                    <li><a href="product-details.php?producto=11">Lomo</a></li>
                                                    <li><a href="product-details.php?producto=13">Picaña</a></li>
                                                    <li><a href="product-details.php?producto=123">Peceto</a></li>
                                                    <li><a href="product-details.php?producto=13">Picada</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="category-menu-dropdown-right">
                                    ...
                                    <a href="#"><img alt="" src="">Bifes<i class="zmdi zmdi-chevron-right"></i></a>
                                            ...
                                            <div class="category-menu-dropdown-left">
                                                ...
                                                <div class="category-part-2 category-common">
                                                    <h4 class="categories-subtitle"></h4>
                                                    <ul>
                                                    <li><a href="product-details.php?producto=18">Churrasquito de paleta</a></li>
                                                    <li><a href="product-details.php?producto=16">Bife angosto</a></li>
                                                    <li><a href="product-details.php?producto=15">Ojo ancho</a></li>
                                                    <li><a href="product-details.php?producto=17">Churrasquito de cuadril</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="category-menu-dropdown-right">
                                       ...
                                       <div class="category-menu-dropdown">
                                            <div class="category-menu-dropdown-left">
                                                ...
                                                <div class="category-part-2 category-common">
                                                    <h4 class="categories-subtitle"></h4>
                                                    <ul>
                                                    <li><a href="product-details.php?producto=19">Chinchulin</a></li>
                                                    <li><a href="product-details.php?producto=23">Riñon</a></li>
                                                    <li><a href="product-details.php?producto=21">Falsa entraña</a></li>
                                                    <li><a href="product-details.php?producto=20">Chorizo de cerdo</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="category-menu-dropdown-right">
                        ...
                        <div class="product-categories-all">
                            ...
                            <ul>
                                <?php
                                     ...
                                     ?>
                                      <li><a class="quick-view modal-view detail-link" href="product-details.php?producto=<?php echo $producto['id']?>"><?php echo $producto['nombre']?></a></li>
                                    <?php
                                    }
                                ?>
                             </ul>
                                        ...
                                        <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                    ...
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            ...
                                                            <ul class="product__action">
                                                                <li><a data-toggle="modal" data-target="#productModal" title="Quick View" class="quick-view modal-view detail-link" href="product-details.php?producto=<?php echo $producto['id']?>"><span class="ti-plus"></span></a></li>
                                                        ...
                                                        <h2><a href="product-details.php"><?php echo $producto['nombre']?></a></h2>
                                            ...
                                            <!-- <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    ...
                                                    <div class="product__details">
                                                        <h2><a href="product-details.php">Entraña</a></h2>
                                                        <ul class="product__price">
                                                            <li class="old__price">$16.00</li>
                                                            <li class="new__price">$10.00</li>
                                                        </ul>
