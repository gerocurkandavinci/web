                    ...
                    <div class="col-md-9 col-lg-9 col-sm-8 col-xs-12 float-left-style">
                        ...
                        <div class="slider__container slider--one">
                            <div class="slider__activation__wrap owl-carousel owl-theme">
                                <!-- Start Single Slide -->
                                <div class="slide slider__full--screen slider-height-inherit slider-text-right" style="background: rgba(0, 0, 0, 0) url(images/carne/slyder/carne.jpg) no-repeat scroll center center / cover ;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4 col-sm-12 col-xs-12">
                                                <div class="slider__inner">
                                                    <h1>Frigorifico First <span class="text--theme"><br>Productos de calidad</span></h1>
                                                    <div class="slider__btn">
                                                        <a class="htc__btn" href="cart.html">Ver Carrito de compras</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- End Single Slide -->
                                <!-- Start Single Slide -->
                                <div class="slide slider__full--screen slider-height-inherit  slider-text-left" style="background: rgba(0, 0, 0, 0) url(images/carne/slyder/frigorifico.jpg) no-repeat scroll center center / cover ;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                                                <div class="slider__inner">
                                                    <h1>Titulo 2 <span class="text--theme">Carnes finamente seleccionadas</span></h1>
                                                    <div class="slider__btn">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    ...
                                                    <div class="product__details">
                                                        <h2><a href="product-details.html">Asado del centro</a></h2>
                                        ...
                                        <div class="product-slider-active owl-carousel">
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    ...
                                                    <div class="product__details">
                                                        <h2><a href="product-details.html">Milanesa de cuadrara</a></h2>
                                                        <ul class="product__price">
                                                            <li class="old__price">$16.00</li>
                                                            <li class="new__price">$10.00</li>
                                                        </ul>
