                                    ...
                                    <?php
                                     $categorias = json_decode(file_get_contents(DIR_BASE.'datos/categoria.json'),TRUE);	
                                                ...
                                                foreach($categorias as $cat){   
                                                   ?>
                                                    <!-- <button class="is-checked"> <?php echo $cat['nombre']?> </button>  -->
                                                   <a class="is-checked" style="font-size:15px;color: #666666;margin:20px;hover:red;" href="?categoria=<?php echo $cat['id']?>"><?php echo $cat['nombre']?></a>                                                
                                                   <?php
                                                }
                                                
                                             ?>                                 
                                    <a class="is-checked" style="font-size:15px;color: #666666;margin:20px;hover:red;" href="?categoria="null"">Todos</a>
                                </div>
                                        ...
                                        <div class="single__filter">
                                            ...
                                            <?php
                                                ...
                                                foreach($marcas as $mar){   
                                                   ?>
                                                    <li><a href="?marca=<?php echo $mar['id']?>?>&categoria=<?php echo (isset($_GET['categoria']))?$_GET['categoria']:""; ?>"><?php echo $mar['nombre']?></a></li>
                                                   <?php
                                                }
                                             ?>
                                               <li><a href="?marca=&categoria=<?php echo (isset($_GET['categoria']))?$_GET['categoria']:""; ?>">Todas</a></li>
                                            </ul>
                                        </div>                                             
                                        <!-- <div class="single__filter">
                                            <h2>Productos</h2>
                                ...
                                <div class="product foo">
                                    <div class="product__inner">
                                        <div class="pro__thumb">
									        ...
									        if(!empty($imagenes)){?>
									    	<img src="<?php echo str_replace('small','big',$imagenes[1])?>" alt="">
									        <?php }else{ ?>
                                                <img src="<?php echo $producto['imagen']?>" alt="product images">
									        <?php } ?>
                                        </div>
